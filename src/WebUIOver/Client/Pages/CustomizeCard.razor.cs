...
public partial class CustomizeCard
{
    ...
    [Inject] private QuickStartProfileFiller _quickStartProfileFiller { get; set; } = default!;
    ...
    [Inject] private QuickStartProfileSaver _QuickStartProfileSaver { get; set; } = default!;
    ...
    protected override async Task OnInitializedAsync()
    {
        ...
        await _quickStartProfileFiller.Fill(_customizeCardContext);
    }
    ...
    private async Task SaveAll()
    {
        ...
        await _QuickStartProfileSaver.Save(_customizeCardContext, _progressContext, Snackbar, StateHasChanged);
