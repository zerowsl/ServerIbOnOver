...
public class MobileSuitUsageContext
{
    ...
    public string[] BurstChartLabels = ["Extend", "Fighting", "Shooting"];
    ...
    public string[] BurstBarChartXAxisLabels { get; set; } = { "", "Extend", "Fighting", "Shooting", "" };
    public List<ChartSeries> BurstBarChartData = new()
    {
        ...
        new ChartSeries() { Name = "", Data = new double[] { 0, 0, 0, 0, 0 } },
        new ChartSeries() { Name = "Extend", Data = new double[] { 0, 0, 0, 0, 0 } },
        new ChartSeries() { Name = "Fighting", Data = new double[] { 0, 0, 0, 0, 0 } },
        new ChartSeries() { Name = "Shooting", Data = new double[] { 0, 0, 0, 0, 0 } },
        new ChartSeries() { Name = "", Data = new double[] { 0, 0, 0, 0, 0 } }
    };
