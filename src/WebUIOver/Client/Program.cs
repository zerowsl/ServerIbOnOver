...
builder.Services.AddSingleton<QuickStartProfileFiller, QuickStartProfileFiller>();
...
builder.Services.AddSingleton<QuickStartProfileSaver, QuickStartProfileSaver>();
