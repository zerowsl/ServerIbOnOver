...
public class GetTrainingProfileCommandHandler(ServerDbContext context) : IRequestHandler<GetTrainingProfileCommand, TrainingProfile>
{
    public Task<TrainingProfile> Handle(GetTrainingProfileCommand request, CancellationToken cancellationToken)
    {
        ...
        var trainingProfile = context.TrainingProfileDbSet
        ...
        var r = trainingProfile.ToTrainingProfile();
