...
public partial class LoadClassMatchCommand2Handler // : IRequestHandler<LoadClassMatchCommand, Response>
{    
    internal Task<Response> HandleOb(LoadClassMatchCommand2 command, CancellationToken cancellationToken)
    {
    ...
    static DateTime GetNextMonday(DateTime start)
    {
