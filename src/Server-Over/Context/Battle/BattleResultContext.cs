...
public class BattleResultContext
{
	...
	public PlayerBadgeDomain? PlayerBadgeDomain { get; set; }
    ...
    public StageResultInfoDomain StageResultInfoDomain { get; set; } = new(); // ib
    ...
    public NetworkDataDomain NetworkDataDomain { get; set; } = new ();
}