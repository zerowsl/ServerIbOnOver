...
public class SoloAceThresholdFiller : IClassMatchFillerCommand
{
    private readonly ServerDbContext _context;

    public SoloAceThresholdFiller(ServerDbContext context)
    {
        _context = context;
    }
    ...
    public void Fill(Response.LoadClassMatch loadClassMatchResponse)
    {
        ...
        var percentiles = _context.SoloAcePercentileViews.ToList();
