...
public class SoloPilotThresholdFiller : IClassMatchFillerCommand
{
    private readonly ServerDbContext _context;

    public SoloPilotThresholdFiller(ServerDbContext context)
    {
        _context = context;
    }
    ...
    public void Fill(Response.LoadClassMatch loadClassMatchResponse)
    {
        ...
        var topPlayer = _context.SoloClassMatchRecordDbSet
            ...
            .FirstOrDefault(x => x.ClassId == RankType.Pilot);
        ...
        var percentiles = _context.SoloPilotPercentileViews.ToList();
        ...
        RatePosition.FillableRatePositions.ToList()
            .ForEach(percentage =>
            {
                ...
                //var targetRate = 0;
                var targetRate = (int)RatePosition.DefaultRate;
        ...
        loadClassMatchResponse.RateThresholds1s.Add(rateThreshold);
    }
}