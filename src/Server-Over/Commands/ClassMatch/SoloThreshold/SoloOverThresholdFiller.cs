...
public class SoloOverThresholdFiller : IClassMatchFillerCommand
{
    private readonly ServerDbContext _context;

    public SoloOverThresholdFiller(ServerDbContext context)
    {
        _context = context;
    }
    ...
    public void Fill(Response.LoadClassMatch loadClassMatchResponse)
    {
        ...
        var percentiles = _context.SoloOverPercentileViews.ToList();
