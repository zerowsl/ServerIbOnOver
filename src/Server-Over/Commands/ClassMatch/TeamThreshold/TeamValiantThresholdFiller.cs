...
public class TeamValiantThresholdFiller : IClassMatchFillerCommand
{
    private readonly ServerDbContext _context;

    public TeamValiantThresholdFiller(ServerDbContext context)
    {
        _context = context;
    }
    ...
    public void Fill(Response.LoadClassMatch loadClassMatchResponse)
    {
        ...
        var percentiles = _context.TeamValiantPercentileViews.ToList();
