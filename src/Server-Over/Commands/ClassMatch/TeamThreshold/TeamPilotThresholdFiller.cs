...
public class TeamPilotThresholdFiller : IClassMatchFillerCommand
{
    private readonly ServerDbContext _context;

    public TeamPilotThresholdFiller(ServerDbContext context)
    {
        _context = context;
    }
    ...
    public void Fill(Response.LoadClassMatch loadClassMatchResponse)
    {
        ...
        var percentiles = _context.TeamPilotPercentileViews.ToList();
