...
public class TeamOverThresholdFiller : IClassMatchFillerCommand
{
    private readonly ServerDbContext _context;

    public TeamOverThresholdFiller(ServerDbContext context)
    {
        _context = context;
    }
    ...
    public void Fill(Response.LoadClassMatch loadClassMatchResponse)
    {
        ...
        var topPlayer = _context.TeamClassMatchRecordDbSet
            ...
            .FirstOrDefault(x => x.ClassId == RankType.Over);
        ...
        var percentiles = _context.TeamOverPercentileViews.ToList();
        ...
        loadClassMatchResponse.RateThresholds4s.Add(rateThreshold);
    }
}