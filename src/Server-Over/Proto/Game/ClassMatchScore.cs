...
public partial class ClassMatchScore2 : global::ProtoBuf.IExtensible
{
    ...
    public partial class Row : global::ProtoBuf.IExtensible
    {
        ...
        [global::ProtoBuf.ProtoMember(10007, Name = @"title_ornament_id", IsRequired = true)] // 7
        public uint TitleOrnamentId { get; set; }
        [global::ProtoBuf.ProtoMember(10008, Name = @"title_effect_id", IsRequired = true)] // 8
        public uint TitleEffectId { get; set; }
        [global::ProtoBuf.ProtoMember(10009, Name = @"title_background_parts_id", IsRequired = true)] // 9
        public uint TitleBackgroundPartsId { get; set; }

        [global::ProtoBuf.ProtoMember(7, Name = @"custom_txt")]
        ...
        [global::ProtoBuf.ProtoMember(8, Name = @"group_name")]
        public string GroupName { get; set; }
        
        [global::ProtoBuf.ProtoMember(9, Name = @"fav_ms_id", IsRequired = true)]
        public uint FavMsId { get; set; }
        
        [global::ProtoBuf.ProtoMember(10, Name = @"skin_id", IsRequired = true)]
        public uint SkinId { get; set; }
        
        [global::ProtoBuf.ProtoMember(11, Name = @"ms_used_num", IsRequired = true)]
        public uint MsUsedNum { get; set; }

        [global::ProtoBuf.ProtoMember(12, Name = @"home_loc_name", IsRequired = true)]
        public string HomeLocName { get; set; }

        [global::ProtoBuf.ProtoMember(13, Name = @"home_loc_pref", IsRequired = true)]
        public uint HomeLocPref { get; set; }

        [global::ProtoBuf.ProtoMember(14, Name = @"open_record", IsRequired = true)]
        public uint OpenRecord { get; set; }

        [global::ProtoBuf.ProtoMember(15, Name = @"play_num", IsRequired = true)]
        public uint PlayNum { get; set; }
        [global::ProtoBuf.ProtoMember(16, Name = @"win_num", IsRequired = true)]
        public uint WinNum { get; set; }

        [global::ProtoBuf.ProtoMember(17, Name = @"class_id_solo", IsRequired = true)]
        public uint ClassIdSolo { get; set; }
        [global::ProtoBuf.ProtoMember(18, Name = @"class_id_team", IsRequired = true)]
        public uint ClassIdTeam { get; set; }

        [global::ProtoBuf.ProtoMember(19, Name = @"grade_id_solo", IsRequired = true)]
        public uint GradeIdSolo { get; set; }
        [global::ProtoBuf.ProtoMember(20, Name = @"grade_id_team", IsRequired = true)]
        public uint GradeIdTeam { get; set; }

        [global::ProtoBuf.ProtoMember(21, Name = @"player_level_id", IsRequired = true)]
        ...
        [global::ProtoBuf.ProtoMember(24, Name = @"badge_id", IsRequired = true)]
        public uint BadgeId { get; set; }
        
        //--[global::ProtoBuf.ProtoMember(25, Name = @"name_color_id", IsRequired = true)]
        //--public uint NameColorId { get; set; }

        [global::ProtoBuf.ProtoMember(25, Name = @"open_player_level", IsRequired = true)]
