...
namespace ServerOver.Persistence
{
    public class ServerDbContext(DbContextOptions<ServerDbContext> options) : DbContext(options)
    {
        ...
        public DbSet<QuickStartInfoProfile> QuickStartInfoDbSet { get; set; }
        
        // Title Domain
        public DbSet<UserTitleSetting> UserTitleSettingDbSet { get; set; }
        
        public DbSet<PlayerLevel> PlayerLevelDbSet { get; set; }
		public DbSet<PlayerBadge> PlayerBadgeDbSet { get; set; }
        ...
        public DbSet<SoloClassMatchGRecord> SoloClassMatchGRecordDbSet { get; set; }
        public DbSet<TeamClassMatchGRecord> TeamClassMatchGRecordDbSet { get; set; }
        ...
        public DbSet<VsRouteBattleStageHighScoreInfo> VsRouteBattleStageHighScoreInfoDbSet { get; set; }
        ...
        // Battle Data
        public DbSet<VsRouteBattleStageDataInfo> VsRouteBattleStageDataInfoDbSet { get; set; }
