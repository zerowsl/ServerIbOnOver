...
public class SoloClassMatchGRecordConfigurations : IEntityTypeConfiguration<SoloClassMatchGRecord>
{
    public void Configure(EntityTypeBuilder<SoloClassMatchGRecord> builder)
    {
        builder.HasKey(x => x.Id);
    }
}